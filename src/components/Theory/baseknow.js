...
const Baseknow = () => {
  ...
  let knowledge = [
    ...
    [
      ...
      '<img alt="что-то пошло не так.." src="../../image/installation.jpg"/>',
    ],
    [
      'закон ома',
      'выглядит',
    ...
    [
      'электрон',
      '- это',
      'субатомная частица, чей электрический заряд отрицателен и равен по модулю одному элементарному электрическому заряду. Электроны принадлежат к первому поколению лептонных частиц и обычно считаются фундаментальными частицами, поскольку у них нет известных компонентов или субструктур',
    ],
    //35
    [
      'температура',
